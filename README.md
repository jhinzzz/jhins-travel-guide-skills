...
- [`skills/jhins-trip-planner/references/travel-sources.md`](./skills/jhins-trip-planner/references/travel-sources.md): canonical travel information sources, cross-referencing rules, login-wall fallback (search aggregators), and citation format
- [`skills/jhins-trip-planner/references/knowledge-layers.md`](./skills/jhins-trip-planner/references/knowledge-layers.md): dual-layer knowledge model (Reasoning vs Local Knowledge), bright-line test, per-category degradation, destination-matching framework, search advisory cards, and the login-wall exhaustion gate
...
- [`skills/jhins-trip-planner/references/attractions.md`](./skills/jhins-trip-planner/references/attractions.md): attraction rules — booking lead times, capacity and timed entry, last admission, seasonal closure, anchor density per day
- [`skills/jhins-trip-planner/assets/trip-data.schema.md`](./skills/jhins-trip-planner/assets/trip-data.schema.md): field list for the `trip` object every HTML deliverable embeds
- [`skills/jhins-trip-planner/assets/validate.js`](./skills/jhins-trip-planner/assets/validate.js): zero-dependency validator for that object (`node validate.js <trip.json | page.html>`, `--selftest`, `--gcj02-to-wgs84`)
